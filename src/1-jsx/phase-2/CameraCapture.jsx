      ...
      <div className="camera-capture-page">
        ...
        <div className="content-wrapper">
          <div className="error-message">
            ...
            <p>{error}</p>
            <Button text="TRY AGAIN" position="center" onClick={startCamera} />
          </div>
        </div>
        <div className="navigation-buttons">
          <Button
      ...
      <div className="camera-container">
        ...
        {permissionStatus === "denied" && (
          <div className="permission-overlay">
            ...
            <p>
              To take your photo, we need access to your camera. Please allow
              camera permissions in your browser settings and refresh the page.
            </p>
            <div className="nav-button" onClick={handleBack}>
              <BackButtonWhite />
            </div>
        ...
        {permissionStatus === "prompt" && (
          <div className="permission-overlay">
            <h3>Enable Camera</h3>
            <p>
              Click the button below to allow camera access and start taking
              your photo.
            </p>
            <Button
              text="ENABLE CAMERA"
